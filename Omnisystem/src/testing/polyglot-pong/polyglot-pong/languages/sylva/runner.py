#!/usr/bin/env python3
"""
Polyglot Pong - Sylva Runner
Executes Pong in Sylva (pure functional) and outputs JSON trace
"""

import sys
import json

# For now, use the Python reference implementation
# This will be replaced with actual Sylva interpreter when available
...
def update(state, up1, down1, up2, down2):
    """Update game state with fixed-point arithmetic"""
    p1 = state["paddle1_y"]
    if up1:
        p1 = max(0, p1 - 1966)
    if down1:
