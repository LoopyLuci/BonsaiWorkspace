# Migration: agent-capabilities-registry

## Original Location
`crates/agent-capabilities-registry/`

## New Location
`titan/agent-capabilities/agent-capabilities-registry/`

## Details
- Language: titan
- Category: agent-capabilities
- Original Rust Structs: 1
- Original Rust Functions: 0
0
- Original Tests: 7
...
created in the target Omnisystem language (titan).
