//! CLI for omnisystem-9-complete — exercises the crate's real in-memory CRUD Manager.

use omnisystem_9_complete::{CreateRequest, Manager, UpdateRequest};

fn main() -> omnisystem_9_complete::Result<()> {
