use crate::{BMCSResponse, ResponseTier};
...
impl FallbackSystem {
    ...
    pub fn get_fallback_response(tier: ResponseTier) -> BMCSResponse {
        match tier {
    ...
    fn emergency_fallback() -> BMCSResponse {
        BMCSResponse {
    ...
    fn critical_fallback() -> BMCSResponse {
        BMCSResponse {
    ...
    fn elevated_fallback() -> BMCSResponse {
        BMCSResponse {
    ...
    fn moderate_fallback() -> BMCSResponse {
        BMCSResponse {
    ...
    fn unknown_fallback() -> BMCSResponse {
        BMCSResponse {
