//! CLI for procurement-analytics — exercises the crate's real in-memory CRUD Manager.

use procurement_analytics::{CreateRequest, Manager, UpdateRequest};

fn main() -> procurement_analytics::Result<()> {
