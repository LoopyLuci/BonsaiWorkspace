//! CLI for patient-privacy — exercises the crate's real in-memory CRUD Manager.

use patient_privacy::{CreateRequest, Manager, UpdateRequest};

fn main() -> patient_privacy::Result<()> {
