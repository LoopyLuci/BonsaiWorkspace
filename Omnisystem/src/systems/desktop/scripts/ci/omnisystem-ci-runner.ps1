#!/usr/bin/env pwsh
# Omnisystem CI/CD Runner - Execute pipeline stages locally or in CI
# Usage: .\omnisystem-ci-runner.ps1 -Stage all
#        .\omnisystem-ci-runner.ps1 -Stage test -ParallelJobs 4
