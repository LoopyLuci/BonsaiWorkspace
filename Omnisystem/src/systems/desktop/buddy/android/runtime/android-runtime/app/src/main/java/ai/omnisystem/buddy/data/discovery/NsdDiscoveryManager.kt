package ai.omnisystem.buddy.data.discovery
...
class NsdDiscoveryManager @Inject constructor(
    ...
    fun discoverServices(serviceType: String = "_omnisystem._tcp."): Flow<List<NsdServiceInfo>> = callbackFlow {
