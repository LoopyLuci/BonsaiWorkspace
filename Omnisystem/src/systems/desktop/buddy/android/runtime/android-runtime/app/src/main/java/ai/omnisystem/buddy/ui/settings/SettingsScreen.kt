package ai.omnisystem.buddy.ui.settings
...
import ai.omnisystem.buddy.data.storage.ThemeMode
    ...
    Column(
        ...
        AssistChip(
            onClick = {
                ...
                context.startActivity(Intent.createChooser(intent, "Share Omnisystem Logs"))
            },
