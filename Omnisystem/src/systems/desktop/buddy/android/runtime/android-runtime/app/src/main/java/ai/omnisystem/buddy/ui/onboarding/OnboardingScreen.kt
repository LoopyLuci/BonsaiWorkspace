package ai.omnisystem.buddy.ui.onboarding
...
import ai.omnisystem.buddy.data.discovery.DiscoveredWorkspace
...
fun OnboardingScreen(
    ...
    Column(
        ...
        Text("Omnisystem Buddy Setup", style = MaterialTheme.typography.headlineSmall)
        Text(
        ...
        when (state.step) {
            OnboardingStep.Discover -> {
                Text("Discover Omnisystem Workspace instances on your LAN.")
                LazyColumn(
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(220.dp),
