package ai.omnisystem.buddy.data.tdl
...
/**
 * Client for accessing the Omnisystem Training Data Library (TDL) on Android.
 *
 * This wrapper manages a local SQLite copy of the TDL database,
 * synced from the desktop application.
 */
class OmnisystemTdlClient(context: Context) {
...
private class TdlDatabaseHelper(context: Context) :
    SQLiteOpenHelper(context, "omnisystem_tdl.db", null, 1) {
