package ai.omnisystem.shared.data

import android.content.Context
import ai.omnisystem.shared.db.OmnisystemDatabase
import ai.omnisystem.shared.db.*

class OmnisystemDataManager(context: Context) {
    private val database = OmnisystemDatabase.getInstance(context)
    private val dao = database.omnisystemDao()
