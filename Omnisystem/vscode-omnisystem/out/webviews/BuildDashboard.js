...
exports.BuildDashboardPanel = void 0;
...
class BuildDashboardPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(BuildDashboardPanel.viewType, 'Omnisystem Build Dashboard', column || vscode.ViewColumn.One, {
            enableScripts: true,
        ...
        switch (message.command) {
            case 'build': {
                ...
                proc.stdout?.on('data', (d) => {
                    ...
                    lines.forEach((l) => l.trim() && this._log(l));
                });
...
exports.BuildDashboardPanel = BuildDashboardPanel;
BuildDashboardPanel.viewType = 'omnisystem.buildDashboard';
//# sourceMappingURL=BuildDashboard.js.map