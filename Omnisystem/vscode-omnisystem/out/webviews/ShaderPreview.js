...
exports.ShaderPreviewPanel = void 0;
...
class ShaderPreviewPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(ShaderPreviewPanel.viewType, 'HELIX Shader Preview', column || vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    _analyzeShader(source, fileName) {
        ...
        let gpuCost = 'Low';
        if (texSamples > 4 || branches > 8 || lines > 100)
            gpuCost = 'High';
        else if (texSamples > 1 || branches > 3 || lines > 50)
            gpuCost = 'Medium';
...
exports.ShaderPreviewPanel = ShaderPreviewPanel;
ShaderPreviewPanel.viewType = 'omnisystem.shaderPreview';
//# sourceMappingURL=ShaderPreview.js.map