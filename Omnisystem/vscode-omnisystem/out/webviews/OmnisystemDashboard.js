...
exports.OmnisystemDashboardPanel = void 0;
...
class OmnisystemDashboardPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(OmnisystemDashboardPanel.viewType, 'Omnisystem Ecosystem Dashboard', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async _handleMessage(message) {
        ...
        switch (message.command) {
            ...
            case 'omnisystemBuddyConnect':
                ...
                break;
            case 'openBuddyApp':
                vscode.window.showInformationMessage(`Opening Omnisystem Buddy sub-app: ${message.arg}`);
                break;
...
exports.OmnisystemDashboardPanel = OmnisystemDashboardPanel;
OmnisystemDashboardPanel.viewType = 'omnisystem.desktopDashboard';
//# sourceMappingURL=OmnisystemDashboard.js.map