...
class WelcomePanel {
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(WelcomePanel.viewType, 'Welcome to Omnisystem', column, {
            enableScripts: true,
        ...
        switch (message.command) {
            ...
            case 'selectProjectType':
                if (message.projectType) {
                    vscode.window.showInformationMessage(`Project type selected: ${message.projectType}. Scaffold coming soon!`);
                }
                break;
            case 'startTour':
...
WelcomePanel.viewType = 'omnisystem.welcome';
