...
export class BonsaiDashboardPanel {
    public static currentPanel: BonsaiDashboardPanel | undefined;
    public static readonly viewType = 'omnisystem.bonsaiDashboard';
    ...
    public static createOrShow(extensionUri: vscode.Uri): void {
        ...
        const panel = vscode.window.createWebviewPanel(
            BonsaiDashboardPanel.viewType,
            'Bonsai Ecosystem Dashboard',
        ...
        switch (message.command) {
            ...
            case 'openBuddyApp':
                vscode.window.showInformationMessage(
                    `Opening Bonsai Buddy sub-app: ${message.arg}`
                );
                break;
