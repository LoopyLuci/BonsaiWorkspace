...
export class MlStudioPanel {
    public static currentPanel: MlStudioPanel | undefined;
    public static readonly viewType = 'omnisystem.mlStudio';
    ...
    private _trainProcess: cp.ChildProcess | undefined;
    private _trainingInterval: NodeJS.Timeout | undefined;
    ...
    private _fakeConfusionMatrix(n: number): number[][] {
        const mat: number[][] = [];
        for (let i = 0; i < n; i++) {
            const row: number[] = [];
            for (let j = 0; j < n; j++) {
