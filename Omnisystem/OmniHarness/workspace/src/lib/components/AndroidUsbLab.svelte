  ...
  <div class="usb-panel" role="dialog" aria-modal="true" aria-label="Android USB Lab">
    ...
    <div class="usb-body">
      ...
      <div class="form-group">
        ...
        <input id="usb-pkg" type="text" data-workspace-action="AndroidUsbLab:PackageName" style="-webkit-app-region: no-drag;" bind:value={usbPackageName} placeholder="com.workspace.workspace" />
      </div>
