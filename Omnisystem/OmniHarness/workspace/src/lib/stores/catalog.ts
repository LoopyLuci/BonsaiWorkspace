...
// Static list of available Bonsai model variants (released by Prism ML) with
// HuggingFace download URLs. The registry (scanned from disk) uses hash-based
// IDs; we match by filename.
...
export const WORKSPACE_CATALOG: CatalogEntry[] = [
  {
