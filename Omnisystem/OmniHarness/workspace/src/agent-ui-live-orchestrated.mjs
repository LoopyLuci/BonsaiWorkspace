...
async function main() {
  ...
  try {
    ...
    await runCommand('node ./agent-api-smoke.mjs', SRC_DIR, {
      WORKSPACE_SKIP_API: '1',
      WORKSPACE_SKIP_UI: '0',
      WORKSPACE_UI_LIVE: '1',
      WORKSPACE_UI_HEADLESS: '0',
      WORKSPACE_UI_KEEP_OPEN_MS: process.env.WORKSPACE_UI_KEEP_OPEN_MS || '120000',
      WORKSPACE_UI_SLOW_MO_MS: process.env.WORKSPACE_UI_SLOW_MO_MS || '120',
    });
