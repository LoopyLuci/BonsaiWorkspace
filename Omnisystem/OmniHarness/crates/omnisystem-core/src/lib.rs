...
pub use app_module_loader::AppModuleLoader;
...
pub enum OmniMode {
    ...
    OmniOS,
    /// Lightweight subset - fewer modules loaded, lower resource footprint
    Lite,
}
...
mod tests {
    ...
    fn test_omnisystem_modes() {
        ...
        assert_eq!(OmniMode::Lite.name(), "Lite");
    }
}
